            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()?->is_admin)
                        ...
                        <x-nav-link :href="route('admin.concerts.index')" :active="request()->routeIs('admin.concerts.*')">
                            {{ __('Koncerty') }}
                        </x-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                @if (Auth::user()?->is_admin)
                    ...
                    <x-responsive-nav-link :href="route('admin.concerts.index')" :active="request()->routeIs('admin.concerts.*')">
                        {{ __('Koncerty') }}
                    </x-responsive-nav-link>
